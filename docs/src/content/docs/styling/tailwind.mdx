...
Just include these variants and utilities in your main tailwind config CSS file.
...
Essential UI components, each with predefined styles to speed up your development.
