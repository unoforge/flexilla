...
<PreviewTopCodeBottom>
  ...
  <CodeLoader source="DismissFromScreen" noRoundedTop/>
</PreviewTopCodeBottom>
...
<PreviewTopCodeBottom>
  ...
  <CodeLoader source="DismissFromDom" noRoundedTop/>
</PreviewTopCodeBottom>
...
- [View Dismissible Examples with UnoCSS](https://github.com/unoforge/flexilla/tree/main/examples/vanilla/dismissible)
...
Restore the element after it has been hidden or removed.
...
Remove the dismiss and restore listeners attached by the component when the instance is no longer needed.
...
If you want to restore a dismissible instance through markup, add a button with `data-restore-btn`. Restore buttons can live anywhere in the document.

```html
<div id="dismiss-me" data-fx-dismissible>
