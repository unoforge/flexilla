...
<Collout type="important">
  It's important to set some attributes and default styles to make the accordion work correctly. You can follow the provided example.
</Collout>
